...
def main():
    ...
    level_registry, transition_registry, reference_lambda_A, reference_nu_sm1 = get_Mn_I_5432_data()

    # The calculation itself needs frequency, but we will display the results in wavelength
    lambda_A = np.arange(reference_lambda_A -0.5 + 1.5, reference_lambda_A + 0.5 + 1.5, 1e-2)
