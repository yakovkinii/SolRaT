...
def construct_coherence_id(level: Level, K: float, Q: float, J: float, Jʹ: float):
    return construct_coherence_id_from_level_id(level_id=level.level_id, K=K, Q=Q, J=J, Jʹ=Jʹ)


def construct_coherence_id_from_level_id(level_id: str, K: float, Q: float, J: float, Jʹ: float):
...
class Rho:
    ...
    def set_from_level_id(self, level_id: str, K: float, Q: float, J: float, Jʹ: float, value: np.ndarray):
        self.data[construct_coherence_id_from_level_id(level_id=level_id, K=K, Q=Q, J=J, Jʹ=Jʹ)] = value

    def __call__(self, level: Level, K: float, Q: float, J: float, Jʹ: float):
        coherence_id = construct_coherence_id(level=level, K=K, Q=Q, J=J, Jʹ=Jʹ)
