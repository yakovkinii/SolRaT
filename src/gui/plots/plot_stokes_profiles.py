...
class StokesPlotter_IV_IpmV:
    ...
    def add(self, lambda_A, reference_lambda_A, stokes_I, stokes_V, color=None, label=""):
        ...
        self.axs[0].plot(lambda_A - reference_lambda_A, stokes_I / max(stokes_I), label=label, color=color, linewidth=1)
        self.axs[1].plot(lambda_A - reference_lambda_A, stokes_V / max(stokes_I), label=label, color=color, linewidth=1)
        self.axs[2].plot(
            lambda_A - reference_lambda_A,
            (stokes_I + stokes_V) / max(stokes_I + stokes_V),
            "-",
            label=label + " $I+V$",
            color=color,
            linewidth=1,
